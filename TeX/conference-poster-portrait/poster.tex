...
\begin{minipage}[b]{0.75\linewidth}
  \veryHuge \color{NavyBlue} \textbf{Posterior Summarization for the\\
    Causal Linear Model} \color{Black}\\ % Title
  % \Huge\textit{An Exploration of Complexity}\\[2cm] % Subtitle
  \huge \textbf{Spencer
    Woody}\textsuperscript{1}$^{\star}$, \textbf{Carlos
    Carvalho}\textsuperscript{2}, \& \textbf{Jared
    Murray}\textsuperscript{2}  \\%Authors
  \color{mygrey}\LARGE The University of Texas at Austin\\
  \LARGE [1] Department of Statistics and Data Sciences \\
  \LARGE [2] Department of Information, Risk, and Operations \\[0.4cm] % University/organization
  \Large \texttt{spencer.woody@utexas.edu} --- \texttt{spencerwoody.github.io}\\
\end{minipage}
%
\begin{minipage}[b]{0.25\linewidth}
  \includegraphics[width=1.0\linewidth]{img/ut-logo-cropped.pdf} 
\end{minipage}
